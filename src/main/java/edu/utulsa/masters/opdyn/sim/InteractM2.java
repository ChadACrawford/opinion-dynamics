...
/**
 * This is the M2 model referenced in the paper that incorporates repulsion into interactions.
 */
public class InteractM2 implements Interact {
    ...
    public IndepedentVariable updateValue(Independent I, double V) {
        ...
        else if(I == Independent.DELTA) return new InteractM2(EPSILON, MU, V);
        else return new InteractM2(EPSILON, MU, DELTA);
    }
}
